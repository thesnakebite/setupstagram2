<template>
    <div class="w-full">
        ...
        <div v-if="visible" class="w-full pb-2 ml-4">
            <div class="w-full flex items-center">
                <span class="text-gray-600 w-0 h-0">
                    <i class="fa-regular fa-circle fa-solid fa-spinner"></i>
                </span>
            </div>
        ...
        <div class="w-full py-3 px-3 flex items-center justify-between border-t border-gray-300">
            <button @click="dispatchImage" 
                    class="outline-none focus:outline-none">
                    <svg class="text-gray-400 h-6 w-6" 
            ...
            <button v-if="message !=''"
                    @click="sendMessage"
                    class="outline-none focus:outline-none" type="submit">
            ...
            async fileChange(e){
                ...
                await axios.post('/send-file', formData,{
                    ...
                    if(error.response.status === 422){
                        ...
                        this.error = this.sendImage ? _error.image[0] : _error.file[0]
